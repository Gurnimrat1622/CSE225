...
class EditTextCustom(context: Context, attrs: AttributeSet?) :
    ...
    fun init() {
        darkButton = ResourcesCompat.getDrawable(resources, R.drawable.ic_baseline_close1_24, null )
        lightButton = ResourcesCompat.getDrawable(resources, R.drawable.ic_baseline_close_24, null )
